...
<body>
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   <div class="container">
     <a class="navbar-brand" href="index.php"><span>Skill</span>Wave</a>
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        <span class="subheading">Welcome to SkillWave</span>
        <h1 class="mb-4">Ultimate destination for online learning</h1>
        <p class="caps">designed to help you elevate your skills and reach new heights. Whether you're aiming to advance in your career, acquire new knowledge, or explore a new passion, our comprehensive courses are here to guide you every step of the way. Join our vibrant community of learners and start your journey to success with Skillwave today.</p>
          ...
          <div class="login-wrap p-4 p-md-5">
              ...
              <form action="#" class="signup-form">
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="SkillWave">
                </div>
                <div class="form-group">
                    <label class="label" for="email">Email Address</label>
                    <input type="text" class="form-control" placeholder="skillwave@gmail.com">
                </div>
                <div class="form-group">
