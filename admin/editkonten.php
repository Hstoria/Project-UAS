  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
      ...
      <?php }?>
        ...
        <form class="form-horizontal" method="post" action="konfirmasieditkonten.php" enctype="multipart/form-data">
            <div class="card-body">
            <div class="form-group row">
                <label for="judul" class="col-sm-3 col-form-label">Judul</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" name="judul" id="judul" value="<?php echo htmlspecialchars($judul); ?>">
            </div>
          </div>     
          <div class="form-group row">
              <label for="isi" class="col-sm-3 col-form-label">Isi</label>
          <div class="col-sm-7">
              <textarea class="form-control" name="isi" id="editor1" rows="12"><?php echo htmlspecialchars($isi) ?></textarea>
          </div>
          </div> 
        <!-- /.card-body -->
